...
function codexPrompt() {
  return [
    ...
    '',
    'Resolve the real Codex binary first (the Superconductor wrapper can hang non-interactively):',
    '',
    ...
    'Otherwise run exactly this command from the repo root, substituting $CODEX_BIN (one pass only; never resume or follow up):',
    '',
    `  cd ${a.repoRoot} && ${a.codexInvocation}`,
    '',
    'Give it time — minutes, not seconds. Then translate its review into findings:',
